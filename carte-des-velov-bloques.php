...
<head>
	...
	<title>Velib Paris - Carte officieuse des stations et velov bloqués</title>
	...
	<link rel="canonical" href="https://velov.philibert.info/carte-des-velov-bloques.php" />
  ...
  <body>
	...
	<div class="disclaimer">
		* Stations Velib suivant le nombre de velov posiblement bloqués <img src="./images/marker_green0.png" alt="Vert" width="12"><1
		...
		<br>* Cette carte essaye d'évaluer le nombre de velov bloqués dans une stations en se basant sur nombre min de velov enregitré par la station sur les 2 ou 3 derniers jours
